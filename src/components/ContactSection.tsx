        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-10">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4 p-5 rounded-2xl border border-border hover:border-primary/30 transition-colors">
              ...
              <div>
                <p className="text-sm font-semibold text-foreground mb-1">Call / WhatsApp</p>
                <a href="tel:+996223571108" className="text-sm text-muted-foreground hover:text-primary transition-colors block">+996 223 571 108</a>
                <a href="https://wa.me/996223571108" target="_blank" rel="noopener noreferrer" className="text-sm text-[#25D366] hover:opacity-80 transition-opacity block">WA: +996 223 571 108</a>
                <a href="https://wa.me/996555302287" target="_blank" rel="noopener noreferrer" className="text-sm text-[#25D366] hover:opacity-80 transition-opacity block">WA: +996 555 302 287</a>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-5 rounded-2xl border border-border hover:border-primary/30 transition-colors">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">123 Business Centre, Chui Avenue,</p>
